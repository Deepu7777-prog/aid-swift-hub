  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        emergency: "bg-primary text-primary-foreground hover:bg-primary/90 emergency-glow pulse-emergency active:scale-95",
        warning: "bg-secondary text-secondary-foreground hover:bg-secondary/90 warning-glow active:scale-95",
        success: "bg-success text-success-foreground hover:bg-success/90 active:scale-95",
        glass: "glass-effect text-foreground hover:bg-muted/50 active:scale-95",
      },
      size: {
